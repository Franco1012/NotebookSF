...
const useCart = () => {
  ...
  const agregarProducto = (producto, id) => {
    //le agregamos la propiedad id al producto
    producto = { ...producto, id };
    //recorremos el array para verificar si el producto existe
    const productoExistente = cartProducts.find((item) => item.id === id);
  ...
  return { cartProducts, totalCantidad, agregarProducto, vaciarCarrito, eliminarProducto, totalCompra };
};
